        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-6 text-center lg:text-left">
            ...
            <p className="text-base text-gray-500 py-10">
              ...
              Vestibulum ut commodo est, id semper augue.
            </p>
            ...
            <div className="flex justify-center lg:justify-start mt-10">
              <button
                className="btn bg-custom-orange text-white border-none font-semibold rounded-full px-8 text-sm sm:text-base lg:text-lg hover:bg-orange-600 transition duration-300"

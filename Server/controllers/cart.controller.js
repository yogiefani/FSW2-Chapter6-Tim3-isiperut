...
const createCart = async (req, res) => {
    try {
        ...
        if (checkCart) {
            const currentAmount = parseInt(checkCart.amount);
            const currentTotal = parseFloat(checkCart.total);

            const updateCart = await checkCart.update({
